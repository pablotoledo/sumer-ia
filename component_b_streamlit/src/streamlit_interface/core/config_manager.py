...
class ConfigManager:
    ...
    def __init__(self):
        # Buscar archivo de configuración desde el directorio raíz del proyecto
        project_root = Path(__file__).parent.parent.parent.parent
        self.config_path = project_root / "fastagent.config.yaml"
        self.example_config_path = project_root / "fastagent.config.yaml.example"
        self._config = None
        self._load_config()
    ...
    def get_available_providers(self) -> list:
        ...
        providers = []
        provider_keys = ['azure', 'generic', 'openai', 'anthropic']
